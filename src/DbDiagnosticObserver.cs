...
namespace Microsoft.Data.Diagnostics
{
        ...
        IDisposable
    {
        ...
        private readonly Dictionary<string, Action<DbDiagnosticObserver, object>> _methods = new Dictionary<string, Action<DbDiagnosticObserver, object>>
        {
            ...
            {DbDiagnosticListener.EventNames.ConnectionClosing, (observer, value) => observer.OnConnectionClosing((ConnectionPayload)value)},
            {DbDiagnosticListener.EventNames.ConnectionClosed, (observer, value) => observer.OnConnectionClosed((ConnectionPayload)value)},
            {DbDiagnosticListener.EventNames.ConnectionClosingError, (observer, value) => observer.OnConnectionClosingError((ConnectionPayload)value)},
            {DbDiagnosticListener.EventNames.TransactionCommitting, (observer, value) => observer.OnTransactionCommitting((TransactionPayload)value)},
            {DbDiagnosticListener.EventNames.TransactionCommitted, (observer, value) => observer.OnTransactionCommitted((TransactionPayload)value)},
            {DbDiagnosticListener.EventNames.TransactionCommittingError, (observer, value) => observer.OnTransactionCommittingError((TransactionPayload)value)},
            {DbDiagnosticListener.EventNames.TransactionRollingBack, (observer, value) => observer.OnTransactionRollingBack((TransactionPayload)value)},
            {DbDiagnosticListener.EventNames.TransactionRolledBack, (observer, value) => observer.OnTransactionRolledBack((TransactionPayload)value)},
            {DbDiagnosticListener.EventNames.TransactionRollingBackError, (observer, value) => observer.OnTransactionRollingBackError((TransactionPayload)value)}
        };
